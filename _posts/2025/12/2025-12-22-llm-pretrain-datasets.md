...
本文是《[LLM 数据的生产](https://xuesongtap.github.io/2025/12/21/llm-data-produce.html)》的下篇，对主流预训练数据集做纵览。上篇讲训练阶段框架、法律与后训练数据，见 [llm-data-produce](https://xuesongtap.github.io/2025/12/21/llm-data-produce.html)。
